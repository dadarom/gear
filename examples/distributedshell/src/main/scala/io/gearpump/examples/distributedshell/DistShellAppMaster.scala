...
/**
 * https://gearpump.apache.org/releases/latest/dev/dev-non-streaming-example/index.html
 */
class DistShellAppMaster(appContext : AppMasterContext, app : AppDescription) extends ApplicationMaster {
  ...
  override def receive: Receive = {
    //ExecutorSystemStarted： 最终返回的入口;多个worker情况下 应该可以收到多次消息【每个worker一次】
